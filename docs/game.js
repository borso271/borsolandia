...
function resizeCanvas() {
    ...
    canvas.width = maxGameSize;
    canvas.height = maxGameSize; // Keep canvas square

    // Set the cell size based on the canvas dimensions
    CELL_SIZE = Math.floor(maxGameSize / COLS);
    borderWidth = CELL_SIZE/30;
    inset = 0; CELL_SIZE/60;

    // Redraw the maze with the new cell size
    drawMaze();
}
