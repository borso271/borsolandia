...
export class ImmovableWall {
    ...
    render(ctx) {
        ...
        this.coordinates.forEach(([y, x]) => {
            ...
            // Draw individual borders based on neighboring walls
            ctx.beginPath();
    ...
    // Render a single immovable wall cell
    ...
    render(ctx) {
        ...
        this.coordinates.forEach(([y, x]) => {
            ...
            if (this.isPlayer) {
                ...
                ctx.fillStyle = "#00ffff"; // Electric blue for inner circle
                ctx.strokeStyle = "#00e5ff"; // Slightly lighter blue for outer stroke
                ctx.lineWidth = 2;
